...
function detail(events: RawEvent[], submissions: CallDetail["submissions"] = []): CallDetail {
  const summary = {
    call_id: "c1",
    started_at: 100,
    modified_at: 0,
  ...
  return { call_id: "c1", summary, run: null, warnings: [], audio: null, transcript: [], tools: [], staged_actions: [], submissions, errors: [], provenance: [], events };
}
