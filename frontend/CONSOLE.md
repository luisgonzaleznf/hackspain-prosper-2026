...
- Saved calendar appointments link to their source call, opening the full call review. Successful local registrations supply the caller name and patient card, including registrations followed by a booking in the same call.
