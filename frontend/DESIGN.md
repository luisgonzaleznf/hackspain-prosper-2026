...
The landing page's links to console or identity pages, including its ROSARIO logos and “Sign in” actions, open the waitlist dialog. In-page links still scroll to their sections. Above 1100px the bottom-center action stays available unless the header or footer “Sign in” action is visible; unrelated section actions do not hide it. Narrower layouts use the header and footer actions. Preview tables fit their cards and stack their rows on small screens. They scroll with the page, with no nested scrollbar for row entrance animations.
