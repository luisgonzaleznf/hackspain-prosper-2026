<!-- Source: https://hackspain.getprosperapp.com/leaderboard/docs/problems — captured 2026-09-18 ~19:50 CEST. Verbatim copy of the organisers' page; the live page wins if they differ. -->
...
|----|----|----|----|----|----|
| 1 | [The Simple Booking](https://hackspain.getprosperapp.com/leaderboard/#1-the-simple-booking) | `simple_booking` | 4 | 1 | yes |
| 2 | [The Switchboard](https://hackspain.getprosperapp.com/leaderboard/#2-the-switchboard) | `switchboard` | 0 (3 bursts) | — | yes |
| 3 | [The Doctor and the Site](https://hackspain.getprosperapp.com/leaderboard/#3-the-doctor-and-the-site) | `doctor_and_site` | 5 | 2 | yes |
| 4 | [The New Patient](https://hackspain.getprosperapp.com/leaderboard/#4-the-new-patient) | `the_new_patient` | 4 | 2 | not yet |
| 5 | [When Exactly](https://hackspain.getprosperapp.com/leaderboard/#5-when-exactly) | `when_exactly` | 5 | 2 | not yet |
| 6 | [The Rules](https://hackspain.getprosperapp.com/leaderboard/#6-the-rules) | `the_rules` | 5 | 3 | not yet |
| 7 | [No Slot Free](https://hackspain.getprosperapp.com/leaderboard/#7-no-slot-free) | `no_slot_free` | 4 | 2 | not yet |
| 8 | [Change and Cancel](https://hackspain.getprosperapp.com/leaderboard/#8-change-and-cancel) | `change_and_cancel` | 4 | 2 | not yet |
| 9 | [The Third Party](https://hackspain.getprosperapp.com/leaderboard/#9-the-third-party) | `third_party` | 4 | 3 | not yet |
| 10 | [Triage](https://hackspain.getprosperapp.com/leaderboard/#10-triage) | `triage` | 5 | 3 | not yet |
| 11 | [Languages](https://hackspain.getprosperapp.com/leaderboard/#11-languages) | `languages` | 4 | 3 | not yet |
| 12 | [Noise](https://hackspain.getprosperapp.com/leaderboard/#12-noise) | `noise` | 4 | 3 | not yet |
| 13 | [The Difficult Caller](https://hackspain.getprosperapp.com/leaderboard/#13-the-difficult-caller) | `difficult_caller` | 5 | 4 | not yet |
| 14 | [Adversarial and Privacy](https://hackspain.getprosperapp.com/leaderboard/#14-adversarial-and-privacy) | `adversarial` | 4 | 4 | not yet |
| 15 | [The Nearest Site](https://hackspain.getprosperapp.com/leaderboard/#15-the-nearest-site) | `nearest_site` | 4 | 3 | not yet |
| 16 | [The Questions](https://hackspain.getprosperapp.com/leaderboard/#16-the-questions) | `the_questions` | 5 | 3 | not yet |
| 17 | [The Second Policy](https://hackspain.getprosperapp.com/leaderboard/#17-the-second-policy) | `second_policy` | 4 | 4 | not yet |
| 18 | [The Real Call](https://hackspain.getprosperapp.com/leaderboard/#18-the-real-call) | `the_real_call` | 3 | 5 | not yet |

## Public and private cases

[public-cases.json](https://hackspain.getprosperapp.com/leaderboard/assets/public-cases-BH3bsRyz.json) is the published roster with its expected answers. The dashboard's problem pages show the same cases with a `Call` button each.
...
Each case carries the persona the caller plays, the patient data they know, what they are trying to achieve, and the actions the case accepts. Matching follows the [normalization rules](https://hackspain.getprosperapp.com/leaderboard/docs/scoring).

Public cases are representative of the private pool, with one published exception: [problem 11](https://hackspain.getprosperapp.com/leaderboard/#11-languages), whose private cases reach into other languages of Spain.

### Private cases

A private case is generated for the run that asks for it, from a root only the organisers hold. Its answer is never published. While scoring is open you are told whether it passed, whose failure it was and a failure signal — not which field lost, and not the transcript or the audio, which open at the [reveal](https://hackspain.getprosperapp.com/leaderboard/docs/rules#recordings) on Monday. No two runs pose the same case, so there is nothing to hard-code and nothing to look up.

Run All dials private cases only, and it is the only lane the standings count. See [scoring](https://hackspain.getprosperapp.com/leaderboard/docs/rules#the-two-lanes).
