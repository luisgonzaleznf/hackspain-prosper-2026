<!-- Source: https://hackspain.getprosperapp.com/leaderboard/docs/overview — captured 2026-09-18 ~19:50 CEST. Verbatim copy of the organisers' page; the live page wins if they differ. -->
...
1.  **Register your team**, get your key, and stand up an endpoint we can call. The starter kit gets you a talking agent in minutes; everything after that is yours. The desk hands you a debit card with **€100 on it, one per team**, to pay for whatever your agent runs on.
...
→ [Get on the phone](https://hackspain.getprosperapp.com/leaderboard/docs/quickstart)
...
→ [The 18 problems](https://hackspain.getprosperapp.com/leaderboard/docs/problems)
...
→ [Scoring](https://hackspain.getprosperapp.com/leaderboard/docs/rules) · [Who wins](https://hackspain.getprosperapp.com/leaderboard/docs/challenge#who-wins)
...
[Get on the phone](https://hackspain.getprosperapp.com/leaderboard/docs/quickstart) takes you from nothing to an agent answering a judged call. After that: [the clinic](https://hackspain.getprosperapp.com/leaderboard/docs/clinic-api) for the world you are working inside, [the call contract](https://hackspain.getprosperapp.com/leaderboard/docs/contract) for how your agent talks to us, and [scoring](https://hackspain.getprosperapp.com/leaderboard/docs/rules) for what passes.
